...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 29 avr. 2020 à 11:15
...
--
-- Base de données :  `alerteCitoyen62141`
--
...
CREATE TABLE IF NOT EXISTS `adresse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_ville` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_departement` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `destinataire` (
  ...
  `prenom_destinataire` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_destinataire` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `adresse_mail_destinataire` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_telephone_destinataire` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_rue_destinataire` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_rue_destinataire1` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_rue_destinataire2` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(92, 1, 1, 13, NULL, 'dfr', 'Leclercq', 'sfddsf@dfg.fr', '06 20 50 41 46', '92', 'sdfsdf', NULL, 1, 1, 1, '2020-04-06 14:43:55', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(93, 1, 1, 12, NULL, 'dfr', 'Leclercq', 'sfddsf@dfg.fr', '06 20 50 41 46', '92', 'sdfsdf', NULL, 1, 1, 1, '2020-04-06 14:58:14', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(94, 1, 1, 2, NULL, 'david', 'Maurice', 'sfddsf@dfg.fr', NULL, '92', 'rue du paradis', NULL, 0, 1, 1, '2020-04-06 16:29:57', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(96, 1, 1, 1, NULL, 'roger', 'Durand', 'sfd25dsf@dfg.fr', NULL, '952', 'rue de l\'espérance', NULL, 0, 1, 1, '2020-04-15 13:20:31', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(97, 1, 1, 16, NULL, 'roger', 'Durand', 'sfd25dsf@dfg.fr', NULL, '952', 'rue de l\'espérance', NULL, 0, 1, 1, '2020-04-15 13:26:12', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(98, 1, 1, 3, NULL, 'toto', 'toto', 'sfddsf@dfg.fr', '06 20 50 41 46', '952', 'rue de l\'espérance', NULL, 1, 1, 1, '2020-04-16 09:05:48', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(99, 1, 2, 15, NULL, 'refus', 'test', 'sfddsf@dfg.fr', NULL, '92', 'rue du paradis', NULL, 0, 1, 1, '2020-04-16 13:36:34', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(100, 1, 2, 14, NULL, 'dfr', 'tesrefus', 'sfd25dsf@dfg.fr', NULL, '92', 'rue de l\'espérance', NULL, 0, 1, 1, '2020-04-16 13:40:22', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(101, 1, 2, 10, NULL, 'roger', 'Leclercq', 'torkhan@wanadoo.fr', NULL, '92', 'rue des alouettes', NULL, 0, 1, 1, '2020-04-16 13:55:58', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(102, 1, 2, 9, NULL, 'david', 'Leclercq', 'torkhan@wanadoo.fr', NULL, '92', 'rue des alouettes', NULL, 0, 1, 1, '2020-04-16 14:02:18', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(103, 1, 2, 8, NULL, 'david', 'Leclercq', 'torkhan@wanadoo.fr', NULL, '952', 'rue des alouettes', NULL, 0, 1, 1, '2020-04-16 14:06:11', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL),
(104, 1, 2, 14, NULL, 'david', 'Leclercq', 'torkhan@wanadoo.fr', NULL, '92 ter', 'sdfsdf', NULL, 0, 1, 1, '2020-04-16 14:11:47', '2020-04-21 15:12:22', '2020-04-21 15:12:22', NULL);
...
CREATE TABLE IF NOT EXISTS `intervention` (
  ...
  `nom_intervention` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rue_intervention` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ville_intervention` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `longitude` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `latitude` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_debut_intervention` datetime DEFAULT NULL,
  `date_fin_intervention` datetime DEFAULT NULL,
  `commentaire_intervention` longtext COLLATE utf8mb4_unicode_ci,
...
(4, 3, 'Int n°28 décret préfectoral du 22/04/20', 'du colibris', 'Douai', NULL, NULL, '2020-04-01 00:00:00', '2020-04-04 00:00:00', 'de 02h00 à 03h00', '2020-04-22 14:22:52'),
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `contenu_message` longtext COLLATE utf8mb4_unicode_ci,
  `date_envoi` datetime DEFAULT NULL,
  `statut_message` longblob,
  `image1` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `commentaire_message` longtext COLLATE utf8mb4_unicode_ci,
  `date_debut_intervention` datetime DEFAULT NULL,
  `date_fin_intervention` datetime DEFAULT NULL,
  `id_type_intervention_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `motif` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `motif_type` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `service` (
  ...
  `nom_service` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_rue_service` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_rue_service1` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_rue_service2` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_service` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ville_service` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `adresse_mail_service` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_telephone_service` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `commentaire_service` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `type_destinataire` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `destinataire_type` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `type_intervention` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `intervention_type` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `type_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `message_type` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `type_service` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_type` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `nom_utilisateur` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prenom_utilisateur` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_modification_utilisateur` datetime DEFAULT NULL,
  `commentaire_utilisateur` longtext COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `nom_utilisateur` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prenom_utilisateur` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mail_utilisateur` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `validation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `etat_validation` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
